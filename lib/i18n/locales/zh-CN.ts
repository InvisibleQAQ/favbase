const zhCN = {
  ...
  // x.com 书签页右下角浮层按钮（content script）
  'x.fab.fetch': '获取书签',
  'x.fab.progress': '已获取 {{count}} 条…',
  'x.fab.progress.one': '已获取 {{count}} 条…',
  'x.fab.done': '✓ 新收录 {{count}} 条',
  'x.fab.done.one': '✓ 新收录 {{count}} 条',
  'x.fab.error': '获取失败',
  'x.fab.authError': '未捕获到登录会话，请刷新页面后重试',
  'x.fab.authRejected': 'X 拒绝了请求，请重新登录 x.com',
