const zhCN = {
  ...
  'settings.agentBridge.description':
    '把 favbase 知识库接给 Claude Code、Codex 等本机 agent：安装 favbase skill 后，它们就能只读检索你收藏过的内容。检索时 Chrome 与本扩展需保持运行。',
  'settings.agentBridge.enableLabel': '启用 Agent Skills',
  'settings.agentBridge.enableHint': '启用后在后台等待本机 favbase 命令接入：Chrome 120+ 约每 30 秒重试一次，更早的受支持版本约每 60 秒',
  'settings.agentBridge.portLabel': '端口',
  'settings.agentBridge.portHint': '必须与 favbase setup --port 一致',
  'settings.agentBridge.portInvalid': '请输入 1 到 65535 之间的整数端口',
  'settings.agentBridge.tokenLabel': '配对 Token',
  'settings.agentBridge.tokenPlaceholder': '生成 Token 后才能复制配置命令',
  'settings.agentBridge.tokenHint': 'Token 只授予本机只读检索权限。不要分享给不受信任的人或程序。',
  'settings.agentBridge.showToken': '显示配对 Token',
  'settings.agentBridge.hideToken': '隐藏配对 Token',
  'settings.agentBridge.copyToken': '复制配对 Token',
  'settings.agentBridge.generateToken': '生成 Token',
  'settings.agentBridge.resetToken': '重置 Token',
  'settings.agentBridge.statusLabel': '连接状态',
  'settings.agentBridge.stateLoading': '正在读取',
  'settings.agentBridge.stateDisabled': '未启用',
  'settings.agentBridge.stateDisconnected': '未连接',
  'settings.agentBridge.stateConnecting': '连接中',
  'settings.agentBridge.stateConnected': '已连接',
  'settings.agentBridge.lastConnected': '最近连接',
  'settings.agentBridge.neverConnected': '从未连接',
  ...
  'settings.agentBridge.commandsStep1': '安装 CLI（需要 Node.js 20+）：npm install -g favbase',
  'settings.agentBridge.commandsStep2': '复制下面的命令，在终端运行一次：写入本机配置，并为 Claude Code 与 Codex 安装 favbase skill',
  'settings.agentBridge.commandsStep3': '检索时保持 Chrome 与本扩展运行',
  'settings.agentBridge.commandsTokenWarning': '命令中包含配对 Token，请勿公开分享。',
  ...
  'settings.agentBridge.loadFailed': '无法读取 Agent Skills 配置，请刷新设置页后重试',
  'settings.agentBridge.saveFailed': '无法保存 Agent Skills 配置，请重试',
  'settings.agentBridge.connectRequestFailed': '配置已保存，但无法立即请求连接；后台将在下个轮询周期重试',
  'settings.agentBridge.errorMissingToken': '缺少配对 Token，请先生成 Token',
  'settings.agentBridge.errorInvalidPort': '端口无效，请输入 1 到 65535 之间的整数',
  'settings.agentBridge.errorBadToken': '配对 Token 与本机 favbase 配置不一致。复制并运行修复命令，然后执行 favbase daemon restart。',
  'settings.agentBridge.errorBadOrigin': '本机 favbase 拒绝了当前扩展身份',
  'settings.agentBridge.errorVersion': '协议版本不兼容，请升级 favbase CLI',
  'settings.agentBridge.errorConnectionClosed': '本机 favbase 已断开，下一次 favbase 命令会自动重新拉起',
  'settings.agentBridge.errorConnection': '尚未连接本机 favbase：在终端运行任意 favbase 命令（如 favbase doctor）并确认端口一致',
  ...
  'configurationBlocker.llm.one': '有 {{count}} 个条目正在等待生成 AI 标签。',
  'configurationBlocker.configure.asr': '配置 ASR',
  ...
  'dashboard.platformsInUse': '在用平台',
  'dashboard.tagCoverage': '标签覆盖率',
  'dashboard.usedTags': '已用标签',
  'dashboard.taggedCount': '{{value}} 条已打标',
  'dashboard.taggedCount.one': '{{value}} 条已打标',
