const zhCN = {
  ...
  'settings.agentBridge.enableHint': '启用后每 30 秒在后台尝试连接本机 favbase daemon（由 favbase CLI 自动拉起）',
  ...
  'settings.agentBridge.errorBadToken': '本机 daemon 的 token 不匹配，请重新复制并运行 setup 命令，然后 favbase daemon restart',
