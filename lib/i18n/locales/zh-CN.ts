const zhCN = {
  ...
  'settings.agentBridge.description':
    '让 Claude Code、Codex 等本机 agent 通过只读工具检索 favbase 知识库。Chrome 与扩展必须保持运行。',
  'settings.agentBridge.enableLabel': '启用 Agent Bridge',
  'settings.agentBridge.enableHint': '启用后每 30 秒在后台尝试连接本机 MCP 进程',
  'settings.agentBridge.portLabel': 'Bridge 端口',
  'settings.agentBridge.portHint': '必须与 MCP 命令中的 FAVBASE_BRIDGE_PORT 一致',
  'settings.agentBridge.portInvalid': '请输入 1 到 65535 之间的整数端口',
  'settings.agentBridge.tokenLabel': 'Bridge Token',
  'settings.agentBridge.tokenPlaceholder': '生成 token 后才能复制连接命令',
  'settings.agentBridge.tokenHint': 'token 只授予本机只读检索权限。不要分享给不受信任的人或程序。',
  'settings.agentBridge.showToken': '显示 Bridge Token',
  'settings.agentBridge.hideToken': '隐藏 Bridge Token',
  'settings.agentBridge.copyToken': '复制 Bridge Token',
  ...
  'settings.agentBridge.retryAt': '下次重试：{{time}}',
  'settings.agentBridge.commandsTitle': '添加到 agent',
  'settings.agentBridge.commandsHint': '复制并在终端运行对应命令。命令包含 Bridge Token，请勿公开。',
  'settings.agentBridge.copyClaude': '复制 Claude Code 命令',
  'settings.agentBridge.copyCodex': '复制 Codex 命令',
  ...
  'settings.agentBridge.saveFailed': '无法保存 Agent Bridge 配置，请重试',
  'settings.agentBridge.connectRequestFailed': '配置已保存，但无法立即请求连接；后台将在下个轮询周期重试',
  'settings.agentBridge.errorMissingToken': '缺少 Bridge Token，请先生成 token',
  'settings.agentBridge.errorInvalidPort': '端口无效，请输入 1 到 65535 之间的整数',
  'settings.agentBridge.errorBadToken': 'MCP 进程的 token 不匹配，请重新复制并运行命令',
  'settings.agentBridge.errorBadOrigin': 'MCP 进程拒绝了当前扩展身份',
  'settings.agentBridge.errorVersion': 'Bridge 协议版本不兼容，请升级 favbase-mcp',
  'settings.agentBridge.errorConnectionClosed': '本机 MCP 进程已断开，请确认 agent 会话仍在运行',
  'settings.agentBridge.errorConnection': '无法连接本机 MCP 进程，请确认命令已运行且端口一致',
  ...
  'dashboard.tagCount': '{{value}} 个标签',
  'dashboard.tagCount.one': '{{value}} 个标签',
