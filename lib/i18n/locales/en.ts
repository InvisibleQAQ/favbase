...
const en: Record<LocaleKeys, string> = {
  ...
  'settings.agentBridge.title': 'Agent Bridge',
  'settings.agentBridge.description':
    'Let local agents such as Claude Code and Codex search the favbase knowledge base through read-only tools. Chrome and the extension must remain running.',
  'settings.agentBridge.enableLabel': 'Enable Agent Bridge',
  'settings.agentBridge.enableHint': 'When enabled, tries to reach the local MCP process every 30 seconds',
  'settings.agentBridge.portLabel': 'Bridge port',
  'settings.agentBridge.portHint': 'Must match FAVBASE_BRIDGE_PORT in the copied MCP command',
  'settings.agentBridge.portInvalid': 'Enter an integer port from 1 to 65535',
  'settings.agentBridge.tokenLabel': 'Bridge Token',
  ...
  'settings.agentBridge.showToken': 'Show Bridge Token',
  'settings.agentBridge.hideToken': 'Hide Bridge Token',
  'settings.agentBridge.copyToken': 'Copy Bridge Token',
  ...
  'settings.agentBridge.retryAt': 'Next retry: {{time}}',
  'settings.agentBridge.commandsTitle': 'Add to an agent',
  'settings.agentBridge.commandsHint': 'Copy and run the matching terminal command. It contains the Bridge Token, so do not publish it.',
  'settings.agentBridge.copyClaude': 'Copy Claude Code command',
  'settings.agentBridge.copyCodex': 'Copy Codex command',
  ...
  'settings.agentBridge.saveFailed': 'Could not save Agent Bridge settings — try again',
  ...
  'settings.agentBridge.errorMissingToken': 'Bridge Token is missing — generate one first',
  'settings.agentBridge.errorInvalidPort': 'The port is invalid — enter an integer from 1 to 65535',
  'settings.agentBridge.errorBadToken': 'The MCP process has a different token — copy and run the command again',
  'settings.agentBridge.errorBadOrigin': 'The MCP process rejected this extension identity',
  'settings.agentBridge.errorVersion': 'Bridge protocol versions do not match — update favbase-mcp',
  'settings.agentBridge.errorConnectionClosed': 'The local MCP process disconnected — confirm the agent session is still running',
  'settings.agentBridge.errorConnection': 'Cannot reach the local MCP process — confirm the command is running on the same port',
  ...
  'dashboard.tagCount.one': '{{value}} tag',
