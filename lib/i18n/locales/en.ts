...
const en: Record<LocaleKeys, string> = {
  ...
  'settings.agentBridge.enableHint': 'When enabled, tries to reach the local favbase daemon (started by the favbase CLI) every 30 seconds',
  ...
  'settings.agentBridge.errorBadToken': 'The local daemon has a different token — copy and run the setup command again, then favbase daemon restart',
