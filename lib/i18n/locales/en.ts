...
const en: Record<LocaleKeys, string> = {
  ...
  'settings.agentBridge.title': 'Agent Skills',
  'settings.agentBridge.description':
    'Give Claude Code, Codex and other local agents your favbase knowledge base: once the favbase skill is installed they can search what you saved, read-only. Chrome and this extension must stay running while they search.',
  'settings.agentBridge.enableLabel': 'Enable Agent Skills',
  'settings.agentBridge.enableHint': 'When enabled, waits in the background for a local favbase command: retried about every 30 seconds on Chrome 120+, or every 60 seconds on earlier supported versions',
  'settings.agentBridge.portLabel': 'Port',
  'settings.agentBridge.portHint': 'Must match favbase setup --port',
  'settings.agentBridge.portInvalid': 'Enter an integer port from 1 to 65535',
  'settings.agentBridge.tokenLabel': 'Pairing token',
  'settings.agentBridge.tokenPlaceholder': 'Generate a token before copying a setup command',
  'settings.agentBridge.tokenHint': 'The token grants local read-only search access. Do not share it with untrusted people or programs.',
  'settings.agentBridge.showToken': 'Show pairing token',
  'settings.agentBridge.hideToken': 'Hide pairing token',
  'settings.agentBridge.copyToken': 'Copy pairing token',
  'settings.agentBridge.generateToken': 'Generate token',
  'settings.agentBridge.resetToken': 'Reset token',
  'settings.agentBridge.statusLabel': 'Connection status',
  'settings.agentBridge.stateLoading': 'Loading',
  'settings.agentBridge.stateDisabled': 'Disabled',
  'settings.agentBridge.stateDisconnected': 'Disconnected',
  'settings.agentBridge.stateConnecting': 'Connecting',
  'settings.agentBridge.stateConnected': 'Connected',
  'settings.agentBridge.lastConnected': 'Last connected',
  'settings.agentBridge.neverConnected': 'Never connected',
  ...
  'settings.agentBridge.commandsStep1': 'Install the CLI (needs Node.js 20+): npm install -g favbase',
  'settings.agentBridge.commandsStep2': 'Copy the command below and run it once in a terminal: it writes the local config and installs the favbase skill for Claude Code and Codex',
  'settings.agentBridge.commandsStep3': 'Keep Chrome and this extension running while agents search',
  'settings.agentBridge.commandsTokenWarning': 'The command contains your pairing token — do not share it publicly.',
  ...
  'settings.agentBridge.loadFailed': 'Could not load Agent Skills settings — reload Settings and try again',
  'settings.agentBridge.saveFailed': 'Could not save Agent Skills settings — try again',
  'settings.agentBridge.connectRequestFailed': 'Settings were saved, but an immediate connection could not be requested. Background polling will retry.',
  'settings.agentBridge.errorMissingToken': 'The pairing token is missing — generate one first',
  'settings.agentBridge.errorInvalidPort': 'The port is invalid — enter an integer from 1 to 65535',
  'settings.agentBridge.errorBadToken': 'The pairing token does not match the local favbase config. Copy and run the repair command, then run favbase daemon restart.',
  'settings.agentBridge.errorBadOrigin': 'The local favbase process rejected this extension identity',
  'settings.agentBridge.errorVersion': 'Protocol versions do not match — update the favbase CLI',
  'settings.agentBridge.errorConnectionClosed': 'The local favbase process disconnected — the next favbase command starts it again',
  'settings.agentBridge.errorConnection': 'Not connected to local favbase yet — run any favbase command (such as favbase doctor) in a terminal and confirm the port matches',
  ...
  'dashboard.taggedCount.one': '{{value}} tagged item',
