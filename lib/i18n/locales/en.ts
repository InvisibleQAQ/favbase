...
const en: Record<LocaleKeys, string> = {
  ...
  'settings.agentBridge.enableHint': 'When enabled, tries to reach the local favbase daemon about every 30 seconds on Chrome 120+ or every 60 seconds on earlier supported versions',
