...
const en: Record<LocaleKeys, string> = {
  ...
  'settings.github.hint': 'Create a Personal Access Token on GitHub: no scopes are needed for public repositories; grant the relevant repo scopes to include private repositories.',
  'settings.github.createToken': 'Create a token',
