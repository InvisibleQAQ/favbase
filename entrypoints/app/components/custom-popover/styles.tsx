...
/** Nudges the paper away from its anchor so the arrow has room to sit. */
...
/**
 * The paper carries a faint corner gradient; when the arrow lands on a tinted
 * corner it has to pick up the same tint or it reads as a seam.
 */
...
type StyledArrowProps = ArrowProps & {
  /** Null until the paper has been measured — see `custom-popover.tsx`. */
  paperRect: ElementRect | null;
...
export const Arrow = styled('span', {
  ...
  // The arrow mounts before either box is known: it is what finds the paper
  // (it reads its own parentElement). Until both boxes are in, it stays out of
  // the render tree visually while remaining mounted as the measuring handle.
