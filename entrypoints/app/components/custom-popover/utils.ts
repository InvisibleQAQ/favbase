...
/** Mirrors a horizontal origin for right-to-left layouts. */
...
/** Anchor/transform origin pair for a placement, mirrored when RTL. */
...
/**
 * Centres the arrow on the anchor, then clamps it so it cannot slide past the
 * paper's rounded corners.
 */
