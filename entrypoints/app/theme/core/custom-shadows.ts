...
/**
 * Minimal overlay/card shadow tokens. Both schemes cast real shadows — dark
 * uses the black channel — so `card` is never `'none'` (docs/25 Step 1
 * overturns the docs/23 hairline-only dark card).
 */
